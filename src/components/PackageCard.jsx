...
const Meal = <div className='py-2 px-3 border-round-sm bg-blue-100 flex justify-content-center align-items-center gap-1'> <GiMeal className='text-sm text-blue-600' /><span className='text-xs text-blue-700'>Meal</span></div>

const Time =(days)=> <div className='p-1 border-round-sm bg-blue-100 flex justify-content-center align-items-center gap-1'> <FaClock className='text-sm text-blue-600' /><span className='text-xs text-blue-700'>{days}Days</span></div>

const Guide = ()=> <div className='p-1 border-round-sm bg-blue-100 flex justify-content-center align-items-center gap-1'> <RiGuideLine className='text-sm text-blue-600' /><span className='text-xs text-blue-700'>Guide</span></div> 
...
export default function PackageCard({data}) {
  ...
  return (
    <div className='border-1 border-200 w-12 h-12rem flex border-round-sm'>
        <div className=' w-4'>
          <img src={image} alt="" className='h-full w-full ' style={{objectFit:'cover'}} />
        </div>
        <div className='w-8 flex p-2 '>
          <div className='w-8 flex flex-column justify-content-between'>
            <div>
